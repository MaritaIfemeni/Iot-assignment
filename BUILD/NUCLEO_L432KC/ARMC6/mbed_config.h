...
#define MBED_CONF_APP_ESP_RX_PIN                                              PB_7                                                                                             // set by application
#define MBED_CONF_APP_ESP_TX_PIN                                              PB_6                                                                                             // set by application
#define MBED_CONF_APP_MQTT_AUTH_METHOD                                        "use-token-auth"                                                                                 // set by application
#define MBED_CONF_APP_MQTT_AUTH_TOKEN                                         "Maito!*tila561"                                                                                 // set by application
#define MBED_CONF_APP_MQTT_BROKER_HOSTNAME                                    "y2gcve.messaging.internetofthings.ibmcloud.com"                                                 // set by application
#define MBED_CONF_APP_MQTT_BROKER_PORT                                        1883                                                                                             // set by application
#define MBED_CONF_APP_MQTT_CLIENT_ID                                          "d:y2gcve:A_MKR1000:F3AC"                                                                        // set by application
#define MBED_CONF_APP_MQTT_TOPIC                                              "iot-2/evt/test/fmt/json"                                                                        // set by application
#define MBED_CONF_APP_WIFI_PASSWORD                                           "karhuhirvimuumipeikko"                                                                          // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "Muumilaakso"                                                                                    // set by application
...
#define MBED_CONF_ESP8266_BUILT_IN_DNS                                        1                                                                                                // set by application[*]
...
#define MBED_CONF_ESP8266_PROVIDE_DEFAULT                                     0                                                                                                // set by application[*]
